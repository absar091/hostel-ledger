...
## 2026-09-05 - Adding Radix Tooltips to Sidebar
**Learning:** Replaced native title attributes with Radix UI Tooltips in the collapsed Sidebar to prevent delayed and inconsistently styled tooltips. Verified TooltipProvider is available globally.
**Action:** Replaced title with Tooltip in Sidebar.
