...
## 2026-08-30 - [Global Middleware Bypass]
**Vulnerability:** Global rate limiter and authentication middleware bypassed because routers were mounted earlier in the file.
**Learning:** Express middleware order is sequential; global middlewares must precede route definitions.
**Prevention:** Enforce consistent middleware mounting order.
