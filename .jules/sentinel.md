...
## 2024-05-24 - Rate limiting bypass on early mounted routers
**Vulnerability:** Rate limiters were defined and applied after early mounted routers.
**Learning:** Global middleware like rate limiters must be applied before routers to be effective.
**Prevention:** Mount global rate limiter middleware early in the Express application setup.
