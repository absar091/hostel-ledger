...
## 2026-03-16 - Predictable Ticket IDs in Support
**Vulnerability:** Support tickets were generated using `crypto.randomBytes(3)`, resulting in short and predictable identifiers.
**Learning:** Relying on low-entropy ID generation is insecure and makes identifiers predictable, allowing attackers to potentially enumerate or guess support ticket IDs to view other users' tickets or manipulate the system.
**Prevention:** Always use cryptographically secure methods like `crypto.randomBytes(8)` to generate IDs, tokens, or ticket numbers to ensure they are long and secure.
