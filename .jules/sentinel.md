...
## 2024-05-24 - Rate Limit Middleware Ordering Bypass
**Vulnerability:** Rate limit bypass on critical endpoints.
**Learning:** Express middleware order matters. Global rate limiters mounted after route definitions do not apply to those routes.
**Prevention:** Always mount global rate limiters before the routers they are intended to protect.
