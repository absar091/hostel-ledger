...
## 2024-06-15 - Missing Explicit Authentication Middleware
**Vulnerability:** Endpoints accessing req.user lacked explicit authenticate middleware in their definitions.
**Learning:** Relying on implicit or assumed global middleware in Express can lead to authentication bypasses and unhandled TypeErrors if req.user is undefined.
**Prevention:** Always explicitly include authenticate middleware in the route definition for any endpoint that accesses req.user.
