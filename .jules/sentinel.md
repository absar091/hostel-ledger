...
## 2024-04-14 - Add noopener noreferrer to target="_blank"
**Vulnerability:** Reverse tabnabbing risk due to missing rel="noopener noreferrer" on target="_blank" anchor tags.
**Learning:** Found multiple instances where external or new-tab links were added without this essential attribute, risking malicious redirection of the parent window.
**Prevention:** Always include `rel="noopener noreferrer"` when setting `target="_blank"` on links.
