...
**Vulnerability:** Found target="_blank" on external links without rel="noopener noreferrer" which allows the opened page to potentially interact with the original page (reverse tabnabbing).
**Learning:** We must consistently apply rel="noopener noreferrer" on all links that open in a new tab.
**Prevention:** Always pair target="_blank" with rel="noopener noreferrer" to ensure defense in depth.
