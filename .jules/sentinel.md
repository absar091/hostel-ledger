...
## 2026-08-27 - Rate Limiter Bypass Vulnerability
**Vulnerability:** Global rate limiter (generalLimiter) was mounted after critical API routers (/api/admin, /api/user), bypassing protection.
**Learning:** Middleware execution order is critical in Express. Rate limiters intended for global paths must be mounted before the routes they protect.
**Prevention:** Ensure global security middlewares are explicitly mounted before any routers they are intended to secure.
