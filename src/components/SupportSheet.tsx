        ...
        <div className="flex-1 overflow-y-auto py-6">
          {ticketId ? (
            <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
              ...
              <button className="px-4 py-2 mt-6 bg-primary text-white rounded-lg font-medium hover:bg-primary/90 disabled:opacity-50 flex justify-center items-center w-full max-w-xs" onClick={handleClose}>Close</button>
            </div>
          ) : (
