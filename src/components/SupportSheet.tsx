        ...
        <div className="flex-1 overflow-y-auto py-6">
          {ticketId ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button className="px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary/90 disabled:opacity-50 flex justify-center items-center w-full mt-4" type="submit" disabled={loading}>
