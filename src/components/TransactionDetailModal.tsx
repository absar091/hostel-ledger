                        ...
                        <div className="flex items-center gap-2 lg:gap-3 ml-3 lg:ml-4">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-wait flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95 relative z-20"
                                ...
                                <div className="absolute inset-0 z-30 w-full h-full">
                                    <Tooltip content="Share as Image" position="top" className="w-full h-full opacity-0" showIcon={false}>
                                    ...
                                    <div className="flex items-center gap-2 bg-slate-50 px-3 py-2 rounded-xl border border-slate-100 shadow-sm transition-all hover:border-emerald-200 group">
                                        ...
                                        <div className="relative">
                                            <button
                                                ...
                                                className={`p-2 rounded-full transition-all relative z-20 ${isCopied
                                            ...
                                            <div className="absolute inset-0 z-30 w-full h-full">
                                                <Tooltip content={isCopied ? "Copied!" : "Copy Reference"} position="top" className="w-full h-full opacity-0" showIcon={false}>
                                                    <div className="w-full h-full" />
                                                </Tooltip>
                                            </div>
                                        </div>
