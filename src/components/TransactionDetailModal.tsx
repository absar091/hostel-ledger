                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button
                                            ...
                                            className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-blue-500 hover:bg-blue-600 focus-visible:ring-2 outline-none disabled:opacity-50 disabled:cursor-wait flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95"
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button
                                            onClick={onClose}
                                            className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-gray-900 hover:bg-gray-800 focus-visible:ring-2 outline-none flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95"
                                            aria-label="Close"
                                        >
