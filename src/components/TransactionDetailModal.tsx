                                            ...
                                            <Tooltip open={isCopied ? true : undefined}>
                                                <TooltipTrigger asChild>
                                                    <button
                                                        ...
                                                        className={`p-2 rounded-full transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-emerald-500 ${isCopied
