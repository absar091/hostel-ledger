                        ...
                        <div className="flex items-center gap-2 lg:gap-3 ml-3 lg:ml-4">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent side="bottom" className="bg-gray-900 text-white border-gray-800 text-xs">
                                  <p>Share as Image</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                                          ...
                                          <Tooltip>
                                            <TooltipTrigger asChild>
                                              <button
                                                  ...
                                                  className={`p-2 rounded-full transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${isCopied
                                            ...
                                            <div className="mt-3 flex gap-4 bg-white/50 p-3 rounded-2xl border border-[#4a6850]/10 shadow-sm">
                                                ...
                                                <div className="flex flex-col justify-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-1.5 text-xs text-blue-600 font-black uppercase tracking-wider hover:underline w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm"
