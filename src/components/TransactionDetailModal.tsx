                        ...
                        <div className="flex items-center gap-2 lg:gap-3 ml-3 lg:ml-4">
                            ...
                            >
                                {isGenerating ? (
                                    ...
                                    <Image aria-hidden="true" className="w-4 lg:w-5 h-4 lg:h-5 text-white font-bold" />
                                )}
                            </button>
                            <button
                                onClick={onClose}
                            ...
                            >
                                <X aria-hidden="true" className="w-4 lg:w-5 h-4 lg:h-5 text-white font-bold" strokeWidth={3} />
                            </button>
                        </div>
                    </div>
