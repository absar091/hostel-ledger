...
import { ArrowUpRight, ArrowDownLeft, CreditCard, Users, User, X, Share2, Copy, Download, Image as ImageIcon, Check, MessageSquareText, MapPin } from "lucide-react";
                                    ...
                                    <TooltipTrigger asChild>
                                        ...
                                        >
                                            {isGenerating ? (
                                                ...
                                                <ImageIcon className="w-4 lg:w-5 h-4 lg:h-5 text-white font-bold" />
                                            )}
                                        </button>
                                    </TooltipTrigger>
                                    <TooltipContent>
