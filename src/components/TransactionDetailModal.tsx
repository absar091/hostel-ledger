                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <button
                                        ...
                                        aria-label={t('share_as_image') || "Share as Image"}
                                    >
                                        {isGenerating ? (
                                ...
                                <TooltipContent>
                                    {t('share_as_image') || "Share as Image"}
                                </TooltipContent>
                            </Tooltip>
                            <button
                                onClick={onClose}
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <button
                                                    ...
                                                    aria-label={isCopied ? (t('copied') || "Copied!") : (t('copy_reference') || "Copy Reference")}
                                                >
                                                    {isCopied ? (
                                            ...
                                            <TooltipContent>
                                                {isCopied ? (t('copied') || "Copied!") : (t('copy_reference') || "Copy Reference")}
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </div>
