                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <button
                                        ...
                                        aria-label={t('Share as Image') || 'Share as Image'}
                                    >
                                        {isGenerating ? (
                                ...
                                <TooltipContent>
                                    <p>{t('Share as Image') || 'Share as Image'}</p>
                                </TooltipContent>
                            </Tooltip>
                            <button
                                onClick={onClose}
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <button
                                                    ...
                                                    aria-label={t(isCopied ? "Copied!" : "Copy Reference") || (isCopied ? "Copied!" : "Copy Reference")}
                                                >
                                                    {isCopied ? (
                                            ...
                                            <TooltipContent>
                                                <p>{t(isCopied ? "Copied!" : "Copy Reference") || (isCopied ? "Copied!" : "Copy Reference")}</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </div>
