                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button
                                            ...
                                            className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-wait flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95 focus-visible:ring-2 focus-visible:ring-blue-500 outline-none"
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button
                                            onClick={onClose}
                                            className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-gray-900 hover:bg-gray-800 flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95 focus-visible:ring-2 focus-visible:ring-gray-900 outline-none"
                                            aria-label="Close"
                                        >
                                            ...
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <button
                                                        ...
                                                        className={`p-2 rounded-full transition-all focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none ${isCopied
                                            ...
                                            <div className="mt-3 flex gap-4 bg-white/50 p-3 rounded-2xl border border-[#4a6850]/10 shadow-sm">
                                                ...
                                                <div className="flex flex-col justify-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-1.5 text-xs text-blue-600 font-black uppercase tracking-wider hover:underline w-fit focus-visible:ring-2 focus-visible:ring-blue-500 outline-none rounded"
