                        ...
                        <div className="flex items-center gap-2 lg:gap-3 ml-3 lg:ml-4">
                            ...
                            <TooltipProvider delayDuration={0}>
                                <Tooltip>
                                    ...
                                    <TooltipContent side="bottom" sideOffset={8} className="bg-slate-900 text-white font-medium text-xs px-3 py-1.5 shadow-xl">
                                        <p>Share as Image</p>
                                    </TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                                    ...
                                    <div className="flex items-center gap-2 bg-slate-50 px-3 py-2 rounded-xl border border-slate-100 shadow-sm transition-all hover:border-emerald-200 group">
                                        ...
                                        <TooltipProvider delayDuration={0}>
                                            <Tooltip>
                                                ...
                                                <TooltipContent side="top" sideOffset={8} className="bg-slate-900 text-white font-medium text-xs px-3 py-1.5 shadow-xl">
