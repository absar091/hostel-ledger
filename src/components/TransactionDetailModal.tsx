                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button
                                            ...
                                            className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-blue-500 hover:bg-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-wait flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95"
                                        >
                                            {isGenerating ? (
                                    ...
                                    <TooltipContent className="z-[110]">Share as Image</TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button
                                            onClick={onClose}
                                            aria-label="Close"
                                            className="w-9 lg:w-10 h-9 lg:h-10 rounded-full bg-gray-900 hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2 flex items-center justify-center transition-all shadow-lg hover:shadow-xl active:scale-95"
                                        >
                                            <X className="w-4 lg:w-5 h-4 lg:h-5 text-white font-bold" strokeWidth={3} />
                                        </button>
                                    </TooltipTrigger>
                                    <TooltipContent className="z-[110]">Close</TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                        </div>
                    </div>
                                            ...
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <button
                                                        ...
                                                        className={`p-2 rounded-full transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 ${isCopied
                                                ...
                                                <TooltipContent className="z-[110]">{isCopied ? "Copied!" : "Copy Reference"}</TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
                                    </div>
                                </div>
