                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <button
                                        ...
                                        aria-label={t("transactions.share_as_image") || "Share as Image"}
                                    >
                                        {isGenerating ? (
                                ...
                                <TooltipContent>
                                    <p>{t("transactions.share_as_image") || "Share as Image"}</p>
                                </TooltipContent>
                            </Tooltip>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <button
                                                    ...
                                                    aria-label={isCopied ? (t("common.copied") || "Copied!") : (t("transactions.copy_reference") || "Copy Reference")}
                                                >
                                                    {isCopied ? (
                                            ...
                                            <TooltipContent>
                                                <p>{isCopied ? (t("common.copied") || "Copied!") : (t("transactions.copy_reference") || "Copy Reference")}</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </div>
