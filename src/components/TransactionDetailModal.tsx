                    ...
                    <div className="flex items-center justify-between p-4 lg:p-6 border-b border-[#4a6850]/10 bg-gradient-to-r from-[#4a6850]/5 to-[#3d5643]/5 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2 lg:gap-3 ml-3 lg:ml-4">
                            ...
                            <TooltipProvider>
                                ...
                                aria-label={t('transaction.share_as_image', 'Share as Image')}
                            >
                                {isGenerating ? (
                                    ...
                                    <TooltipContent side="top" className="bg-gray-900 text-white border-gray-800 text-xs">
                                        <p>{t('transaction.share_as_image', 'Share as Image')}</p>
                                    </TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                            <button
                                ...
                                <div className="flex flex-col items-center gap-2 mb-6">
                                    <div className="flex items-center gap-2 bg-slate-50 px-3 py-2 rounded-xl border border-slate-100 shadow-sm transition-all hover:border-emerald-200 group">
                                        ...
                                        <TooltipProvider>
                                            ...
                                            aria-label={isCopied ? t('transaction.copied', 'Copied!') : t('transaction.copy_reference', 'Copy Reference')}
                                        >
                                            {isCopied ? (
                                                ...
                                                <TooltipContent side="top" className="bg-gray-900 text-white border-gray-800 text-xs">
                                                    <p>{isCopied ? t('transaction.copied', 'Copied!') : t('transaction.copy_reference', 'Copy Reference')}</p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
                                    </div>
