                                            ...
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <button
                                                        ...
                                                        className={`p-2 rounded-full transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${isCopied
                                                            ? "bg-emerald-100 text-emerald-600 scale-110 focus-visible:ring-emerald-500"
                                                            : "bg-white text-slate-400 hover:text-emerald-600 shadow-sm border border-slate-100 group-hover:border-emerald-200 focus-visible:ring-slate-400"
                                                            }`}
