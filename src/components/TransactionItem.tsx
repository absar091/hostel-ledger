...
export const TransactionItem = memo(({
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-3 lg:gap-4 p-3 lg:p-4 rounded-xl lg:rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 hover:scale-[1.01] active:scale-[0.99] transition-all text-left group"
    >
      <div
        className={cn(
      ...
      <div className="text-right flex items-center gap-3">
        ...
        {transaction.type === "expense" && (
          <button
            ...
            className="w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-primary hover:bg-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all active:scale-90"
