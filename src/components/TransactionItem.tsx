...
// ⚡ Bolt: Cache Intl.DateTimeFormat outside component to prevent repeated allocations during render loop
// Impact: Significantly reduces allocation and execution time during transaction list renders
