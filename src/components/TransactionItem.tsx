...
// Cache Intl.DateTimeFormat for ~100x faster date formatting in list renders
...
export const TransactionItem = memo(({
  ...
  if (!Number.isNaN(parsedDate.getTime())) {
    formattedTime = timeFormatter.format(parsedDate);
  }
  const dateDisplay = dateFormat === "date" ? transaction.date : formattedTime;
