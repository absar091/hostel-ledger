...
// Bolt: Pre-instantiate Intl.DateTimeFormat for faster list renders
// Reusing the formatter avoids creating a new instance on every render
  ...
  const dateDisplay =
    dateFormat === "date"
      ...
      : timeFormatter.format(
        new Date(transaction.timestamp || transaction.date)
      );
