...
// ⚡ Bolt: Cache Intl.DateTimeFormat instantiation for performance
// Instantiating this inside a frequently rendered list item is slow.
// Pre-instantiating it as a singleton is ~40x faster.
