      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span className="text-sm font-medium">{t('quick_actions.add_expense')}</span>
          </Button>
        </TooltipTrigger>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground">{t('quick_actions.received')}</span>
          </Button>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="bg-gray-900 text-white border-gray-800">
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground">{t('quick_actions.new_group')}</span>
          </Button>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="bg-gray-900 text-white border-gray-800">
