  ...
  return (
    <div className="wallet-card mobile-margin mb-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex-1">
          ...
          <div className="text-white text-currency-large mb-1">
            {formatAmount(availableBudget || 0)}
          </div>
      ...
      <div className="border-t border-white/20 pt-4 mb-4">
        ...
        <div className={`text-currency-medium mb-1 ${settlementDelta > 0 ? 'text-emerald-300' :
          settlementDelta < 0 ? 'text-red-300' :
            'text-white'
          }`}>
          {settlementDelta > 0 ? '+' : ''}{formatAmount(settlementDelta || 0)}
        </div>
        <div className="text-white/60 text-xs">
