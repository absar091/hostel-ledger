    ...
    <TooltipProvider>
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 rounded-xl hover:bg-gray-50 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] focus-visible:ring-offset-2"
