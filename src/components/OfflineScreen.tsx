      ...
      <div className="flex flex-col items-center max-w-md w-full">
        ...
        <div className="relative mb-8">
          ...
          <div className="relative w-28 h-28 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center shadow-[0_20px_60px_rgba(249,115,22,0.3)] border-2 border-orange-400/30">
            ...
            {/* Offline icon */}
            <svg
              className="relative w-14 h-14 text-white z-10"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        {isLoading ? (
          ...
          <>
            {cacheStatus.hasUser &&
            (cacheStatus.hasGroups || cacheStatus.hasTransactions) ? (
              <div className="mb-8 text-center">
                <p className="text-base text-gray-700 font-medium mb-2">
                  Loading your cached data...
                </p>
                <p className="text-sm text-gray-500">
                  {cacheStatus.groupCount} group
                  {cacheStatus.groupCount !== 1 ? "s" : ""} •{" "}
                  {cacheStatus.transactionCount} transaction
                  {cacheStatus.transactionCount !== 1 ? "s" : ""}
                </p>
              </div>
            ) : !cacheStatus.hasUser ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    Your data is cached and will load shortly. Changes will sync
          ...
          <div className="bg-white rounded-2xl p-4 shadow-md border border-gray-100">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  The app will automatically sync your data when you reconnect
                  to the internet.
                </p>
              </div>
            </div>
        ...
        {onRetry && (
          <button
            ...
            disabled={isRetrying}
            className="w-full h-12 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 active:scale-95 disabled:opacity-70 disabled:active:scale-100 flex items-center justify-center gap-2"
          >
            {isRetrying ? (
              <>
