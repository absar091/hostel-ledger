      ...
      <div className="bg-white w-full max-w-sm rounded-3xl shadow-2xl border-2 border-gray-200 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          ...
          <button
            ...
            className="text-gray-400 hover:text-gray-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-full"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
