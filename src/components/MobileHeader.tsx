  ...
  const defaultRightContent = (
    <>
      ...
      <button
        ...
        className="relative group w-10 h-10 rounded-full border border-gray-200 p-0.5 object-contain focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850]"
