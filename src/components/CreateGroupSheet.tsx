          ...
          {currentStep === 3 && (
            <div className="space-y-6 animate-fade-in pt-4">
              ...
              <p className="text-[10px] text-center text-gray-500 mt-2 px-4 leading-tight">
                By creating a group, you agree to our <a href="/group-terms" target="_blank" rel="noopener noreferrer" className="font-bold text-[#4a6850] underline">Group Creation Terms</a> and <a href="/group-privacy" target="_blank" rel="noopener noreferrer" className="font-bold text-[#4a6850] underline">Group Privacy Policy</a>. {/* 🛡️ Sentinel: Prevent Reverse Tabnabbing */}
              </p>
            </div>
          )}
        </div>
