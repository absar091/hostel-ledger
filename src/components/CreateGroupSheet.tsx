                ...
                <div className="space-y-2">
                    ...
                    >
                      <Tooltip delayDuration={0}>
                        <TooltipTrigger asChild>
                          <div className="w-9 h-9 rounded-full bg-purple-100 flex items-center justify-center text-sm font-bold text-purple-600 cursor-help">
                            @
                          </div>
                        </TooltipTrigger>
                        <TooltipContent>
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-full bg-red-100/50 hover:bg-red-100 flex items-center justify-center text-red-500 transition-colors z-10 relative"
                  ...
                  {invitedUsernames.map(username => (
                    ...
                    >
                      <Tooltip delayDuration={0}>
                        <TooltipTrigger asChild>
                          <div className="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center text-sm font-bold text-emerald-600 cursor-help">
