                ...
                <div className="space-y-2">
                  ...
                  {invitedEmails.map(email => (
                    <Tooltip key={email}>
                      <TooltipTrigger asChild>
                        <div className="flex items-center gap-3 p-3 bg-purple-50/50 border border-purple-100 rounded-2xl animate-fade-in cursor-help">
                      ...
                      <TooltipContent>
                        <p>{t('sheets.create_group.tooltip_email_invite') || 'This person will receive an email invitation to join Hostel Ledger and this group.'}</p>
                      </TooltipContent>
                    </Tooltip>
                  ))}
                  ...
                  {invitedUsernames.map(username => (
                    <Tooltip key={username}>
                      <TooltipTrigger asChild>
                        <div className="flex items-center gap-3 p-3 bg-emerald-50/50 border border-emerald-100 rounded-2xl animate-fade-in cursor-help">
                      ...
                      <TooltipContent>
                        <p>{t('sheets.create_group.tooltip_app_user') || "This user already has a Hostel Ledger account. They'll receive an in-app invitation and email notification."}</p>
                      </TooltipContent>
                    </Tooltip>
                  ))}
