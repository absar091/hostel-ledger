              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {invitedEmails.map(email => (
                    <Tooltip
                      key={email}
                      content="This person will receive an email invitation to join Hostel Ledger and this group."
                      position="top"
                      className="w-full flex"
                    >
                      <div className="flex-1 flex items-center gap-3 p-3 bg-purple-50/50 border border-purple-100 rounded-2xl animate-fade-in">
                        ...
                        <button
                          ...
                          className="w-8 h-8 rounded-full bg-red-100/50 hover:bg-red-100 flex items-center justify-center text-red-500 transition-colors shrink-0"
                  ...
                  {invitedUsernames.map(username => (
                    <Tooltip
                      key={username}
                      content="This user already has a Hostel Ledger account. They'll receive an in-app invitation and email notification."
                      position="top"
                      className="w-full flex"
                    >
                      <div className="flex-1 flex items-center gap-3 p-3 bg-emerald-50/50 border border-emerald-100 rounded-2xl animate-fade-in">
