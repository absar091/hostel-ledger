              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {invitedEmails.map(email => (
                    <TooltipProvider key={email}><Tooltip>
                      <TooltipTrigger asChild>
                        <div
                          className="flex items-center gap-3 p-3 bg-purple-50/50 border border-purple-100 rounded-2xl animate-fade-in cursor-default focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400"
                          tabIndex={0}
                        >
                  ...
                  {invitedUsernames.map(username => (
                    <TooltipProvider key={username}><Tooltip>
                      <TooltipTrigger asChild>
                        <div
                          className="flex items-center gap-3 p-3 bg-emerald-50/50 border border-emerald-100 rounded-2xl animate-fade-in cursor-default focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
                          tabIndex={0}
                        >
