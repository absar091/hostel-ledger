                ...
                <div className="space-y-2">
                  ...
                  {invitedEmails.map(email => (
                    <Tooltip key={email}>
                      <TooltipTrigger asChild>
                        <div
                          className="flex items-center gap-3 p-3 bg-purple-50/50 border border-purple-100 rounded-2xl animate-fade-in focus:outline-none focus:ring-2 focus:ring-purple-400"
                          tabIndex={0}
                        >
                  ...
                  {invitedUsernames.map(username => (
                    <Tooltip key={username}>
                      <TooltipTrigger asChild>
                        <div
                          className="flex items-center gap-3 p-3 bg-emerald-50/50 border border-emerald-100 rounded-2xl animate-fade-in focus:outline-none focus:ring-2 focus:ring-emerald-400"
                          tabIndex={0}
                        >
