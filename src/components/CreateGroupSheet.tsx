              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {invitedEmails.map((email) => (
                    <Tooltip key={email} delayDuration={0}>
                      <TooltipTrigger asChild>
                        <div className="flex items-center gap-3 p-3 bg-purple-50/50 border border-purple-100 rounded-2xl animate-fade-in cursor-default">
                  ...
                  {invitedUsernames.map((username) => (
                    <Tooltip key={username} delayDuration={0}>
                      <TooltipTrigger asChild>
                        <div className="flex items-center gap-3 p-3 bg-emerald-50/50 border border-emerald-100 rounded-2xl animate-fade-in cursor-default">
