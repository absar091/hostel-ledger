              ...
              <div className="flex items-center justify-between mb-3 pl-1">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    aria-label={t("group.settings.copy_invite", "Copy invite link")}
                  >
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <Button
                        ...
                        aria-label={t("group.settings.search_member", "Search for member")}
                      >
                        {isSearching ? (
                    ...
                    <Button
                      ...
                      aria-label={t("group.settings.cancel_add_member", "Cancel adding member")}
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  </div>
