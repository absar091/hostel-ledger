                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        aria-label={t("copy_invite_link", "Copy invite link")}
                    ...
                    <TooltipContent>
                      <p>{t("copy_invite_link", "Copy invite link")}</p>
                    </TooltipContent>
                  </Tooltip>
                  <Button
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            aria-label={t("search_member", "Search for a member")}
                        ...
                        <TooltipContent>
                          <p>{t("search_member", "Search for a member")}</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          ...
                          aria-label={t("cancel_search", "Cancel search")}
                      ...
                      <TooltipContent>
                        <p>{t("cancel_search", "Cancel search")}</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
