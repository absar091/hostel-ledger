  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
          <button
            onClick={onClick}
            className="w-full bg-card rounded-xl p-4 shadow-card hover:shadow-card-hover transition-all duration-200 flex items-center gap-4 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850]"
          >
