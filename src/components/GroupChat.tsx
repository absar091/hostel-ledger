                ...
                <div className="flex items-center gap-2 max-w-full overflow-hidden">
                    <div className="flex items-center">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button
                                    aria-label={t("chat.transaction_tips", "Transaction reference tips")}
                            ...
                            <TooltipContent>
                                <p>{t("chat.transaction_tips", "Transaction reference tips")}</p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                    <input
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button
                                ...
                                className="w-12 h-12 bg-gradient-to-br from-[#4a6850] to-[#3d5643] text-white rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl disabled:opacity-40 disabled:cursor-not-allowed transition-all active:scale-95 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850]"
                            >
                                {isSending ? (
                                    <Loader2 className="w-5 h-5 animate-spin" />
                                ) : (
