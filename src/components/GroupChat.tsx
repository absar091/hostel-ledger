                    ...
                    <div className="absolute bottom-full left-4 mb-2 p-3 bg-white border border-emerald-100 rounded-2xl shadow-xl z-20 max-w-xs animate-in slide-in-from-bottom-2 zoom-in-95">
                        <div className="flex items-start gap-3">
                            ...
                            <button
                                ...
                                aria-label={t("chat.close_hint", "Close hint")}
                                title={t("chat.close_hint", "Close hint")}
                            >
                                <X className="w-3 h-3" />
                            </button>
                        </div>
                ...
                {referencedTxn && (
                    <div className="mb-3 p-3 bg-emerald-50 rounded-xl border border-emerald-200 relative animate-in slide-in-from-bottom-2">
                        <button 
                            ...
                            aria-label={t("chat.remove_referenced_transaction", "Remove referenced transaction")}
                            title={t("chat.remove_referenced_transaction", "Remove referenced transaction")}
                        >
                ...
                {attachedImage && (
                    <div className="mb-3 relative inline-block group animate-in zoom-in-95">
                        ...
                        <button 
                            ...
                            title={t("chat.remove_image", "Remove image")}
                        >
                            <X className="w-3 h-3" />
                        </button>
                    </div>
                ...
                <div className="flex items-center gap-2 max-w-full overflow-hidden">
                    <div className="flex items-center">
                        ...
                        <button
                            ...
                            aria-label={t("chat.show_hint", "Show referencing hint")}
                            title={t("chat.show_hint", "Show referencing hint")}
                        >
