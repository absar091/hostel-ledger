                ...
                {showTxnHint && (
                    <div className="absolute bottom-full left-4 mb-2 p-3 bg-white border border-emerald-100 rounded-2xl shadow-xl z-20 max-w-xs animate-in slide-in-from-bottom-2 zoom-in-95">
                        <div className="flex items-start gap-3">
                            ...
                            <button onClick={() => setShowTxnHint(false)} aria-label="Close referencing hint" className="text-gray-400 hover:text-gray-600 mt-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] focus-visible:ring-offset-2 rounded-full p-1">
                                <X className="w-3 h-3" />
                            </button>
                        </div>
                    </div>
                ...
                {referencedTxn && (
                    <div className="mb-3 p-3 bg-emerald-50 rounded-xl border border-emerald-200 relative animate-in slide-in-from-bottom-2">
                        <button 
                            ...
                            className="absolute top-2 right-2 p-1 hover:bg-emerald-100 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2"
                        >
                ...
                <div className="flex items-center gap-2 max-w-full overflow-hidden">
                    <div className="flex items-center">
                        ...
                        <button
                            ...
                            className="p-2.5 text-[#4a6850]/60 hover:text-[#4a6850] hover:bg-[#4a6850]/5 rounded-xl transition-all disabled:opacity-50 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] focus-visible:ring-offset-2"
                        >
                            {isUploading ? (
                        ...
                        <button
                            ...
                            className={cn(
                                "p-2.5 rounded-xl transition-all shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] focus-visible:ring-offset-2",
