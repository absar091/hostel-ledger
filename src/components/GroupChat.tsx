                ...
                {showTxnHint && (
                    <div className="absolute bottom-full left-4 mb-2 p-3 bg-white border border-emerald-100 rounded-2xl shadow-xl z-20 max-w-xs animate-in slide-in-from-bottom-2 zoom-in-95">
                        <div className="flex items-start gap-3">
                            ...
                            <button onClick={() => setShowTxnHint(false)} aria-label="Close hint" className="text-gray-400 hover:text-gray-600 mt-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] rounded-sm">
                                <X className="w-3 h-3" />
                            </button>
                        </div>
                    </div>
                ...
                {attachedImage && (
                    <div className="mb-3 relative inline-block group animate-in zoom-in-95">
                        ...
                        <button 
                            ...
                            className="absolute -top-2 -right-2 p-1 bg-red-500 text-white rounded-full shadow-lg hover:bg-red-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
                        >
                            <X className="w-3 h-3" />
                        </button>
                    </div>
