            ...
            <div className="px-4 py-3 sm:py-4 bg-white/95 backdrop-blur-md border-t border-[#4a6850]/10 relative pb-[calc(12px+env(safe-area-inset-bottom,0px))]">
                ...
                {showTxnHint && (
                    <div className="absolute bottom-full left-4 mb-2 p-3 bg-white border border-emerald-100 rounded-2xl shadow-xl z-20 max-w-xs animate-in slide-in-from-bottom-2 zoom-in-95">
                        <div className="flex items-start gap-3">
                            ...
                            <button aria-label="Close hint" onClick={() => setShowTxnHint(false)} className="text-gray-400 hover:text-gray-600 mt-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded">
                                <X className="w-3 h-3" />
                            </button>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-2 max-w-full overflow-hidden">
                    <div className="flex items-center">
                        ...
                        <button
                            aria-label={showTxnHint ? "Hide transaction hint" : "Show transaction hint"}
                    ...
                    <button
                        ...
                        className="w-12 h-12 bg-gradient-to-br from-[#4a6850] to-[#3d5643] text-white rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl disabled:opacity-40 disabled:cursor-not-allowed transition-all active:scale-95 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] focus-visible:ring-offset-2 focus-visible:ring-offset-[#f0f4f1]"
                    >
                        {isSending ? (
                            <Loader2 className="w-5 h-5 animate-spin" />
                        ) : (
