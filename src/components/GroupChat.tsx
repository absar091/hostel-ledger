                ...
                {showTxnHint && (
                    <div className="absolute bottom-full left-4 mb-2 p-3 bg-white border border-emerald-100 rounded-2xl shadow-xl z-20 max-w-xs animate-in slide-in-from-bottom-2 zoom-in-95">
                        <div className="flex items-start gap-3">
                            ...
                            <button onClick={() => setShowTxnHint(false)} className="text-gray-400 hover:text-gray-600 mt-0.5" aria-label="Close referencing hint" title="Close hint">
                                <X className="w-3 h-3" />
                            </button>
                        </div>
                    </div>
                ...
                {referencedTxn && (
                    <div className="mb-3 p-3 bg-emerald-50 rounded-xl border border-emerald-200 relative animate-in slide-in-from-bottom-2">
                        <button 
                            ...
                            title="Remove referenced transaction"
                        >
                ...
                <div className="flex items-center gap-2 max-w-full overflow-hidden">
                    <div className="flex items-center">
                        ...
                        <button
                            ...
                            aria-label="Show referencing info"
                            title="Show referencing info"
                        >
