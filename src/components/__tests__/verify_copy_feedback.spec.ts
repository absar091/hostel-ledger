...
test('verify copy id feedback', async ({ page }) => {
  ...
  // Find the Copy ID button (using the aria-label attribute which is initially "Copy Reference" or "Copy ID" depending on context, assuming "Copy Reference" as per code)
