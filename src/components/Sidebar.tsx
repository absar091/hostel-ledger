        ...
        {navItems.map((item) => {
          ...
          return (
            <Tooltip key={item.id} delayDuration={0}>
              ...
              {!isOpen && (
                <TooltipContent side="right" className="bg-[#1B4332] text-white border-none font-medium">
                  {item.label}
                </TooltipContent>
              )}
            </Tooltip>
        ...
        {isOpen ? (
          ...
          <>
            ...
            <Tooltip delayDuration={0}>
              ...
              <TooltipContent side="right" className="bg-red-600 text-white border-none font-medium">
                {t('sidebar.logout')}
              </TooltipContent>
            </Tooltip>
          </>
