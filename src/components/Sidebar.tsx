            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4a6850] to-[#3d5643] flex items-center justify-center mx-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850]"
