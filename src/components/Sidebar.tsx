        ...
        {navItems.map((item: any) => {
          ...
          return !isOpen ? (
            <Tooltip key={item.id}>
              ...
              <TooltipContent side="right" className="bg-[#4a6850] text-white border-[#3d5643] font-bold z-[100]">
                <p>{item.label}</p>
              </TooltipContent>
            </Tooltip>
          ) : buttonContent;
        ...
        {isOpen ? (
          ...
          <>
            ...
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-red-600 text-white border-red-700 font-bold z-[100]">
