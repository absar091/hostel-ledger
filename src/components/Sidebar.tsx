      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            className="absolute -right-3 top-24 w-6 h-6 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] transition-colors shadow-sm"
          >
            {isOpen ? (
            ...
            <Tooltip delayDuration={0}>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4a6850] to-[#3d5643] flex items-center justify-center mx-auto mb-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a6850] transition-all"
