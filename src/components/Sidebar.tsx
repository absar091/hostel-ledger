              ...
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 relative focus-visible:ring-2 focus-visible:outline-none",
                      active
              ...
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4a6850] to-[#3d5643] flex items-center justify-center mx-auto mb-3 focus-visible:ring-2 focus-visible:outline-none"
            ...
            <TooltipProvider>
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <button
                    onClick={handleLogout}
                    className="w-full flex items-center justify-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-100 hover:text-red-600 transition-all duration-200 focus-visible:ring-2 focus-visible:outline-none"
                    aria-label={t('sidebar.logout')}
                  >
                    <LogOut className="w-5 h-5" />
                  </button>
