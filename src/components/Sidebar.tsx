        ...
        {navItems.map((item: any) => {
          ...
          return (
            <Tooltip key={item.id}>
              ...
              {!isOpen && (
                <TooltipContent side="right" className="font-medium bg-[#1B4332] text-white border-[#1B4332]">
                  {item.label}
                </TooltipContent>
              )}
            </Tooltip>
        ...
        {isOpen ? (
          ...
          <>
            ...
            <Tooltip>
              ...
              <TooltipContent side="right" className="font-medium bg-red-600 text-white border-red-600">
                {t('sidebar.logout')}
              </TooltipContent>
            </Tooltip>
          </>
