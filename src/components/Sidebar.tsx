        ...
        {navItems.map((item: any) => {
          ...
          return (
            <Tooltip key={item.id} delayDuration={0}>
              ...
              {!isOpen && (
                <TooltipContent side="right" className="bg-[#1B4332] text-white font-bold border-[#1B4332]">
                  <p>{item.label}</p>
                </TooltipContent>
              )}
            </Tooltip>
        ...
        {isOpen ? (
          ...
          <>
            ...
            <Tooltip delayDuration={0}>
              ...
              <TooltipContent side="right" className="bg-red-600 text-white font-bold border-red-600">
