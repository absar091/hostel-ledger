              ...
              {!isOpen ? (
                <TooltipProvider delayDuration={0}>
                  <Tooltip>
                    ...
                    <TooltipContent side="right" sideOffset={14} className="bg-slate-900 text-white font-medium text-xs px-3 py-1.5 shadow-xl border-none">
                      <p>{item.label}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
          ...
          <>
            ...
            <TooltipProvider delayDuration={0}>
              <Tooltip>
                ...
                <TooltipContent side="right" sideOffset={14} className="bg-slate-900 text-white font-medium text-xs px-3 py-1.5 shadow-xl border-none text-red-400">
