          ...
          if (!isOpen) {
            return (
              <Tooltip key={item.id} delayDuration={0}>
                ...
                <TooltipContent side="right" className="bg-gray-900 text-white font-medium border-0">{item.label}</TooltipContent>
              </Tooltip>
            );
          }
          return button;
        ...
        {isOpen ? (
          ...
          <>
            <Tooltip delayDuration={0}>
              ...
              <TooltipContent side="right" className="bg-gray-900 text-white font-medium border-0">{user?.name || "Profile"}</TooltipContent>
            </Tooltip>
            <Tooltip delayDuration={0}>
              <TooltipTrigger asChild>
                <button
              ...
              <TooltipContent side="right" className="bg-gray-900 text-white font-medium border-0">{t('sidebar.logout')}</TooltipContent>
            </Tooltip>
          </>
        )}
      </div>
