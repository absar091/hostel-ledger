  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white pb-24 lg:pb-0 lg:ml-64">
        ...
        {/* App Header - iPhone Style Enhanced with #4a6850 - Mobile only */}
        <div className="lg:hidden bg-white border-b border-[#4a6850]/10 pt-2 pb-3 px-4 sticky top-0 z-40 shadow-[0_4px_20px_rgba(74,104,80,0.08)]">
        ...
        <div className="px-6 lg:px-8 pt-8 pb-6 lg:max-w-7xl lg:mx-auto">
        ...
        {/* Groups List */}
        <div className="px-6 lg:px-8 lg:max-w-7xl lg:mx-auto">
        {groups.length > 0 ? (
