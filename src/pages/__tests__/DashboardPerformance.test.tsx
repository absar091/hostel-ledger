...
vi.mock("@/components/InvitationsList", () => ({
  default: () => <div data-testid="invitations-list" />,
}));
vi.mock("@/components/TransactionList", () => ({
  TransactionList: () => <div data-testid="transaction-list" />,
}));
vi.mock("@/components/UsernameMigration", () => ({
  default: () => <div data-testid="username-migration" />,
}));
...
vi.mock("@/components/AddExpenseSheet", () => ({
  default: () => <div data-testid="add-expense-sheet" />,
}));
vi.mock("@/components/RecordPaymentSheet", () => ({
  default: () => <div data-testid="record-payment-sheet" />,
}));
vi.mock("@/components/AddMoneySheet", () => ({
  default: () => <div data-testid="add-money-sheet" />,
}));
vi.mock("@/components/PaymentConfirmationSheet", () => ({
  default: () => <div data-testid="payment-confirmation-sheet" />,
}));
