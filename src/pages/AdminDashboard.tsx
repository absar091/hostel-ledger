                         ...
                         {selectedTicket ? (
                           <>
                              <div className="p-10 border-b border-gray-100/50 flex flex-col sm:flex-row justify-between items-start gap-6">
                                 ...
                                 <button aria-label="Close ticket" onClick={() => setSelectedTicket(null)} className="lg:hidden p-3 rounded-2xl bg-gray-50 text-gray-400 hover:bg-red-50 hover:text-red-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"><X className="w-6 h-6" /></button>
                              </div> 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
           ...
           <div className="bg-white rounded-[2rem] w-full max-w-xl relative overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              <div className="p-8 pb-0 flex justify-between items-start">
                 ...
                 <button aria-label="Close user details" onClick={() => setSelectedUser(null)} className="p-2 rounded-full hover:bg-gray-100 text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
                    <X className="w-6 h-6" />
                 </button>
              </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
           ...
           <div className="bg-white rounded-[2rem] w-full max-w-2xl relative overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                 ...
                 <button aria-label="Close group details" onClick={() => setDetailedGroup(null)} className="p-2 rounded-full hover:bg-white text-gray-400 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
                    <X className="w-6 h-6" />
                 </button>
              </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
           ...
           <div className="bg-white rounded-[2rem] w-full max-w-xl relative overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-red-50/50">
                 ...
                 <button aria-label="Close report details" onClick={() => setSelectedReport(null)} className="p-2 rounded-full hover:bg-white text-gray-400 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
                    <X className="w-6 h-6" />
                 </button>
              </div>
