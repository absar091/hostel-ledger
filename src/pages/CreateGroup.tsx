                        ...
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl flex items-start gap-3 border border-gray-200">
                                ...
                                <label htmlFor="terms" className="text-sm text-gray-600 leading-tight">
                                    I agree to the <a href="/terms-of-service" target="_blank" rel="noopener noreferrer" className="font-bold text-[#4a6850] underline">Terms of Service</a> (specifically <a href="/group-terms" target="_blank" rel="noopener noreferrer" className="font-bold text-[#4a6850] underline">Group Creation</a>) and <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="font-bold text-[#4a6850] underline">Privacy Policy</a> (specifically <a href="/group-privacy" target="_blank" rel="noopener noreferrer" className="font-bold text-[#4a6850] underline">Group Privacy</a>). {/* 🛡️ Sentinel: Prevent Reverse Tabnabbing */}
                                </label>
                            </div>
