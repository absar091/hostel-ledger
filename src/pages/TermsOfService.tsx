        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
              ...
              <li><strong>Invitations:</strong> Invite friends via email or username to join your groups</li>
          ...
          {/* PWA Section */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Progressive Web App (PWA) & Offline Use</h2>
            <p className="text-gray-700 leading-relaxed mb-2">
              Hostel Ledger is a Progressive Web App that can be installed on your device.
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li><strong>Offline Data:</strong> We may store data locally on your device to allow offline functionality.</li>
              <li><strong>Sync:</strong> Data recorded offline will sync to our servers when connectivity is restored.</li>
              <li><strong>Updates:</strong> The app updates automatically to provide the latest features and security.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
              <li>Errors in data entry or calculations made by potential bugs</li>
              <li>Disputes between users regarding shared expenses</li>
              <li>Lost funds due to payment to incorrect accounts</li>
              <li><strong>Fake or Fraudulent Transactions:</strong> We do not verify the authenticity of expenses added by users. It is the responsibility of group members to verify expenses with the person who added them.</li>
              <li>Unauthorized access to your account due to weak passwords</li>
            </ul>
          </section>
