...
export const FirebaseAuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // ⚡ Bolt: Selectively memoizing calculation functions with useCallback to maintain
  // referential equality and prevent unnecessary executions in downstream useEffect hooks.
