...
export const FirebaseAuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // ⚡ Bolt: Memoize heavily requested settlement function to prevent unnecessary re-renders in consumer components
  ...
  // ⚡ Bolt: Memoize settlement calculations to avoid redundant work on re-renders
