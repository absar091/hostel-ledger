...
export const FirebaseAuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Memoizing settlement functions to prevent unnecessary recalculations
  // in downstream components, while avoiding stale closures that could
  // occur if the entire context value was memoized.
