...
export const FirebaseAuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // ⚡ OPTIMIZATION: Wrapped calculation functions in useCallback to maintain referential equality.
  // This prevents unnecessary executions in downstream useEffect hooks without needing to memoize the entire provider value.
  ...
  // ⚡ OPTIMIZATION: Memoize getFavoriteGroups to prevent unnecessary downstream re-renders or executions.
