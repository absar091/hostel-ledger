...
// Specifically allow larger payload for audio data endpoint
// MUST be defined before the global express.json limit is applied
app.post('/api/ai/parse-expense-audio', express.json({ limit: '10mb' }));

// Global payload limit to prevent DoS via oversized JSON payloads
