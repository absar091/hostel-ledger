...
class AdminService {
  ...
  async getUserGroups(uid) {
    try {
      ...
      // ⚡ Bolt Optimization: Replace sequential loop with concurrent Promise.all execution.
      // Expected impact: Substantially lower latency by executing N+1 queries in parallel.
